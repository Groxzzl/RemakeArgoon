...
- **Argoon** - Project original yang menjadi dasar (*base code*) dari client modifikasi ini. Terima kasih kepada para pengembang Argoon Client.
- Seluruh kontributor dan maintainer yang membantu pengembangan *Remake* ini.

## ⚠️ Catatan & Disclaimer

**Peringatan:** Fitur-fitur yang ada di dalam client ini (seperti *Auto Totem*, *Fast Place*, dll.) dapat memberikan keuntungan yang tidak seimbang dalam permainan multiplayer. 
- Penggunaan client ini pada server publik (seperti server mini-games atau survival publik) **sangat mungkin melanggar peraturan server (EULA/Server Rules)** dan dapat mengakibatkan akun Anda terkena *banned* atau blokir.
